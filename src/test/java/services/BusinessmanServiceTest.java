...
public class BusinessmanServiceTest extends AbstractTest {
	...
	/*
	 * 1.3: An actor who is not authenticated must be able to register as a businessman. 
	 */
	public void registerTemplate(final String username, final String password, String actorName, String surname, String city, String id, String email, String phone, String postalAddress, final Class<?> expected) {
		...
		try {
			...
			Businessman res = businessmanService.create();
	...
	public void registerDriver() {
		...
		final Object testingData[][] = {
			...
			{"businessmanTest", "businessmanTest", "actorName", "surname", "city", "country", "businessman@mail.com", "+34 (29) 1259", "address", null},
			...
			{"businessmanTest", "businessmanTest", "actorName", "surname", "city", "country", "businessman@mail.com", "6824560", "address", IllegalArgumentException.class}

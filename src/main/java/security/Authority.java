...
public class Authority implements GrantedAuthority {
	...
	@NotBlank
	@Pattern(regexp = "^" + Authority.ADMINISTRATOR + "|" + Authority.FISHERMAN + "|" + Authority.BUYER + "|" + Authority.BUSINESSMAN + "|" + Authority.TRANSPORTER + "$")
	@Override
	...
	public static Collection<Authority> listAuthorities() {
		...
		authority = new Authority();
		authority.setAuthority(Authority.FISHERMAN);
		result.add(authority);
		...
		authority = new Authority();
		authority.setAuthority(Authority.BUSINESSMAN);
		result.add(authority);
